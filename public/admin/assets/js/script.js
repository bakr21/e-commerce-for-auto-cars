...
document.addEventListener("DOMContentLoaded", function() {
    ...
    input.addEventListener('change', function() {
        ...
        previewContainer.innerHTML = ''; // حذف أي معاينة سابقة

        // تكرار عبر كل الملفات المحددة
        for (let i = 0; i < files.length; i++) {
            const file = files[i];
            const reader = new FileReader();

            // إذا تم تحميل الملف بنجاح
            ...
            // قراءة الملف كنص بناءً على البيانات النقل
