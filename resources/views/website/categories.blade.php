...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-center text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3 ps-3">{{__('navbar.categories')}}</span></h2>
            ...
            <a class="text-decoration-none" href="{{route('website.category_slug' , $category->slug)}}">
                <div class="cat-item d-flex align-items-center mb-4">
                    ...
                    <div class="flex-fill pl-3">
                        ...
                        <small class="text-body">{{$category->products_count}} {{__('checkout.products')}}</small>
                    </div>
                </div>
            </a>
        </div>
